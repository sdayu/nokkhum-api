...
@view_defaults(route_name='billing.set_cost', renderer='json', permission='authenticated')
class  ServicePlan:
    ...
    @view_config(route_name="billing.set_cost.create_list", request_method='POST')
    def create(self):
    ...
    @view_config(route_name="billing.set_cost.create_list", request_method='GET')
