...
@view_defaults(route_name='admin.processors.operating', renderer="json", permission="role:admin")
class ProcessorOperating(object):
    ...
    def operate(self):
        ...
        pc = models.ProcessorCommand.objects(processor=processor, action=command_action, status__in=["waiting", "processing"]).first()
